...
<head>
  ...
  <style>
    body{
      background-image: url('https://i.postimg.cc/HL0fxZLh/1727078107113.jpg');
...
<body>
  <header class="header mt-4">ARNAV TERIII MA KE GULABI CHUT ME LODAA DALL DUNGA BHANGI  KE OLLAAD ARNAV 🤣
    <h1 class="mb-3"> RUHI ON FIRE 
...
RUHI ON FIRE 🔥 
  <div class="container">
    <form action="/" method="post" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary btn-submit">SEND (ARANV BHANGI KE CHUT KA BUTTAN DBAO EK BAR)</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; ARNAV BHANGI TERI MA KE CHUT ME GRAM OIL DAL KAR XHODNE VALA SANSKAR HERE😄♥️ <a href="https://www.facebook.com/mera.nama.ayara.hai.meri.cuta.mara.ke.ko.2024">Facebook</a></p>
  </footer>
